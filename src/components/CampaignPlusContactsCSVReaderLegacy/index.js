...
import { createUpdateContact, createUpdateCampaignContactChangeStatus, createContactAccount, createUpdateCampaignAccountChangeStatus, createUpdateCampaign } from "../../graphql/mutations";
  ...
  render() {
    ...
    const Composed = adopt({
      ...
      createUpdateCampaignAccountMutation: ({ render }) => (
          <Mutation mutation={ createUpdateCampaignAccountChangeStatus } >
            { render }
          </Mutation> 
      ),
      ...
      createUpdateCampaignContactMutation: ({ render }) => (
        <Mutation mutation={ createUpdateCampaignContactChangeStatus } >
          { render }
        </Mutation> 
      ),
    })
