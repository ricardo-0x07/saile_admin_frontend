...
export default class FileUpload extends Component {
    state = {
        ...
        error: undefined,
        bucket: "apolloaccountstoprocess",
        entity: {
            bucket: "apolloaccountstoprocess",
            files: [],
            campaign_name: ''
    ...
    uploadFile = async () =>{
        ...
        //     const process_apollo_accounts_report = await processApolloAccounts({entity})
        //     console.log("process_apollo_accounts_report: ", process_apollo_accounts_report)
        // });
